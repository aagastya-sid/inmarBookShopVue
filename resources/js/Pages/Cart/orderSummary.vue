    ...
    <section aria-labelledby="summary-heading" class="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
        ...
        <dl class="mt-6 space-y-4">
            <div class="flex items-center justify-between">
                ...
                <dd class="text-sm font-medium text-gray-900">{{ props.orderSummary.subTotal }}</dd>
            </div>
            <div class="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <dd class="text-sm font-medium text-gray-900">+ {{ props.orderSummary.shippingString }}</dd>
            </div>
            <div class="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <dd class="text-sm font-medium text-gray-900">+ {{ props.orderSummary.taxString }}</dd>
            </div>
            <div class="flex items-center justify-between border-t border-gray-200 pt-4">
                <dt class="text-base font-medium text-gray-900">Order total</dt>
                <dd class="text-base font-medium text-gray-900">{{ props.orderSummary.grandTotalString }}</dd>
            </div>
        </dl>
